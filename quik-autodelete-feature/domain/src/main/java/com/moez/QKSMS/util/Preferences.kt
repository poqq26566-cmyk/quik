...
class Preferences @Inject constructor(
    ...
    val autoDeleteNotifications = rxPrefs.getBoolean("autoDeleteNotifications", false)
    val autoDeleteVerificationCodes = rxPrefs.getBoolean("autoDeleteVerificationCodes", false)
