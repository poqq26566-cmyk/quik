...
interface MessageRepository {
    ...
    fun getOldNotificationCounts(maxAgeDays: Int): Map<Long, Int>

    fun deleteOldNotifications(maxAgeDays: Int)

    fun getOldVerificationCodeCounts(maxAgeDays: Int): Map<Long, Int>

    fun deleteOldVerificationCodes(maxAgeDays: Int)
