...
import dev.octoshrimpy.quik.feature.settings.autodelete.AutoDeleteCategoriesController
...
class MessageUtilsController : QkController<MessageUtilsControllerBinding, MessageUtilsView, MessageUtilsState, MessageUtilsPresenter>(), MessageUtilsView {
    ...
    override fun openAutoDeleteCategories() {
        router.pushController(RouterTransaction.with(AutoDeleteCategoriesController())
