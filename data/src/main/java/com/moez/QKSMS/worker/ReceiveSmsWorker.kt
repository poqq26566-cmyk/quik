...
class ReceiveSmsWorker(appContext: Context, workerParams: WorkerParameters)
    ...
    override fun doWork(): Result {
        ...
        // auto-classify conversation as message/notification based on sender + content
        conversationRepo.autoClassifyNotification(message.threadId, message.address, message.getText())
