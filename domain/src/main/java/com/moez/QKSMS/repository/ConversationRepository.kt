...
interface ConversationRepository {
    ...
    fun getNotificationConversations(unreadAtTop: Boolean = false): RealmResults<Conversation>

    fun getNotificationConversationsSnapshot(unreadAtTop: Boolean = false): List<Conversation>
    ...
    /** Manually move conversations into the "Notifications" tab. Overrides auto-classification. */
    fun markNotification(vararg threadIds: Long)

    /** Manually move conversations into the "Messages" tab. Overrides auto-classification. */
    fun markMessage(vararg threadIds: Long)

    /** Runs the automatic classifier for a conversation, unless the user has manually set its category. */
    fun autoClassifyNotification(threadId: Long, address: String, body: String)
