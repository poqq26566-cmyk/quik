...
open class Conversation(
    ...
    @Index var isNotification: Boolean = false, // true = shown in "Notifications" tab instead of "Messages"
    var notificationManuallySet: Boolean = false, // true once the user manually moves this conversation
